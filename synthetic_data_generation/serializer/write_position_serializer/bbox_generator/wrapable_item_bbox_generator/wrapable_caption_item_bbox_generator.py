...
class WrapableCaptionItemBboxGenerator(WrapableItemBboxGenerator):
    ...
    def _compute_h_bbox_bounds(
        ...
        item = WrapItemsStore().get_item(
            LatexItemTypeNames.CAPTION, lld.data_item_index)
    ...
    def _compute_wrap_pos_left_h_bbox_bounds(
        ...
        left = content_position.get_x_pos_end()
